...
//
//   const resrCountries = Convert.toResrCountries(json);
//
...
export class Convert {
    public static toResrCountries(json: string): Country[] {
        return cast(JSON.parse(json), a(r("ResrCountries")));
    }

    public static resrCountriesToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("ResrCountries"))), null, 2);
    }
}
